// Browse_Performance_Counters.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
//CONST PWSTR BROWSE_DIALOG_CAPTION = new wchar_t("Select a counter to monitor.");

wchar_t wcharFilter[7] = L"filter";
PWSTR BROWSE_DIALOG_CAPTION = wcharFilter;

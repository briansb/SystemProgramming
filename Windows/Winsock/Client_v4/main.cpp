...
int __cdecl main(int argc, char **argv)
{
	...
	if (argc != 2) { printf("usage: %s server-name\n", argv[0]); return 1; }
	...
	// server wakes up on one of these connects
	...
	for (int i = 0; i < 10; ++i) {
		...
		if (i == 5) sendbuf = "this is the middle of the loop";
		if (i == 9) sendbuf = "this is the last pass";
